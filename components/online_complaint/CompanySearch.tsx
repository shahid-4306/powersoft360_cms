...
export interface Company {
  ...
  // Set for a company the customer typed manually (not chosen from the
  // search dropdown) — e.g. in app/online_complaint/page.tsx's
  // makeManualCompany(). Optional so normal search-selected companies
  // are unaffected.
