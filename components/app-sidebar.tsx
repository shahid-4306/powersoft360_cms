...
"use client"
import { CheckSquare, Home, Users, UserCheck, BarChart3, Plus, Archive, Sparkles, Building2 , ClipboardList,FolderKanban,Search, UserPlus, Package, Tags } from "lucide-react"
...
url: "/dashboard/complaint-types",
icon: Tags,
color: "text-cyan-600",
bgColor: "bg-cyan-100",
description: "Manage Complaint Categories",
permission: "complaint-types.manage",
},
{
title: "Reports",
...
// "registrations.manage", "software-types.manage", and
// "complaint-types.manage" are also granted to anyone who already has
// "users.manage" so existing admin roles see the new pages immediately
// without requiring a role reconfiguration.
const filteredItems = items.filter((item) => {
if (user.role.permissions.includes(item.permission)) return true
if (
item.permission === "registrations.manage" ||
item.permission === "software-types.manage" ||
item.permission === "complaint-types.manage"
) {
