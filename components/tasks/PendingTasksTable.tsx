...
// import { Button } from "@/components/ui/button"
// import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card"
// import { Building, User, Phone, FileText, Calendar, UserCheck, Clock, AlertCircle, Zap, AlertTriangle, MapPin, Users, Eye } from "lucide-react"
...
//   onAssignTask: (task: any, isComplaint?: boolean) => void
//   onRejectComplaint?: (complaint: any) => void
//   onViewItem?: (item: any, isComplaint?: boolean) => void
//   /** _id of a complaint/task to scroll into view and highlight (e.g. arrived via a notification link) */
//   highlightItemId?: string | null
// }

// export function PendingTasksTable({ tasks, onlineComplaints, onAssignTask, onRejectComplaint, onViewItem, highlightItemId }: PendingTasksTableProps) {
...
//   // Scroll a specific row (e.g. the complaint just opened from a
//   // notification link) into view once it's rendered.
//   useEffect(() => {
//     if (highlightItemId && highlightedRowRef.current) {
//       highlightedRowRef.current.scrollIntoView({ behavior: "smooth", block: "center" })
//     }
//   }, [highlightItemId, allPendingItems])
...
//                 const isHighlighted = !!highlightItemId && String(item._id) === String(highlightItemId)

//                 return (
//                   <tr
//                     key={item.uniqueId}
//                     ref={isHighlighted ? highlightedRowRef : undefined}
//                     className={`transition-colors ${isHighlighted ? "bg-primary/10 ring-1 ring-inset ring-primary/40 hover:bg-primary/15" : "hover:bg-yellow-50"}`}
//                   >
//                     <td className="px-3 py-2">
//                       {getTypeBadge(isComplaint)}
//                     </td>
...
//                         {onViewItem && (
//                           <Button
//                             onClick={() => onViewItem(item, isComplaint)}
//                             size="sm"
//                             variant="outline"
                    ...
                    <td className="px-3 py-2 hidden md:table-cell">
                      <div className="space-y-1">
                        <span className="text-foreground truncate max-w-[120px] lg:max-w-[150px] block text-xs" 
                              title={isComplaint ? item.complaintRemarks : item.working}>
                          {isComplaint ? 
                            `${item.complaintType ? `[${item.complaintType}] ` : ''}${item.softwareType ? `${item.softwareType}: ` : ''}${item.complaintRemarks || 'No remarks'}` : 
                            item.working || 'N/A'
                          }
                        </span>
