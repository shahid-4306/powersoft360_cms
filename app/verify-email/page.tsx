...
function VerifyEmailContent() {
  ...
  // Where to send the user once their email is verified as "approved".
  // Once verified, the complaint registration form is rendered directly
  // instead of showing an intermediate "Complaint Module" hub page.
  const nextPath = searchParams.get("next") || "/online_complaint"
