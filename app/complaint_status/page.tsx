...
// //         body: JSON.stringify({ complaintNumber: complaint.complaintNumber, action: 'done' }),
// //       })
// //       const data = await res.json()
// //       if (!res.ok) {
...
// //       await refetchComplaint(complaint.complaintNumber)
// //     } catch {
...
// //   const getUserRemark = (): string => {
// //     if (!complaint) return ''
// //     const history = complaint.history || []
// //     // Find the most recent entry with a user action that has remarks
...
// //     // Fallback to the original complaint description
// //     return complaint.complaintRemarks || ''
// //   }

// //   // Developer remark is the resolution remarks
// //   const getDeveloperRemark = (): string => {
// //     return complaint?.resolutionRemarks || ''
// //   }
...
// //                         >
// //                           <div>
// //                             <p className="font-medium text-foreground">{c.complaintNumber}</p>
// //                             <p className="text-xs text-muted-foreground">
// //                               {new Date(c.createdAt).toLocaleDateString()}
// //                             </p>
// //                           </div>
// //                           <div className={`flex items-center space-x-1.5 px-3 py-1 rounded-full text-xs ${cfg.color}`}>
...
// //                   </CardContent>
// //                 </Card>
// //                 {/* Combined Remarks Summary (single row with Date, Software Type) */}
// //                 {complaint && (
// //                   <Card>
// //                     <CardContent className="p-6">
// //                       <h4 className="text-lg font-semibold text-foreground mb-4">Remarks Summary</h4>
// //                       <div className="overflow-x-auto">
// //                         <Table className="table-fixed w-full text-xs">
// //                           <TableHeader>
// //                             <TableRow>
// //                               <TableHead className="w-[15%] text-center text-xs font-semibold py-3">Complaint Code</TableHead>
// //                               <TableHead className="w-[12%] text-center text-xs font-semibold py-3">Date</TableHead>
// //                               <TableHead className="w-[28%] text-center text-xs font-semibold py-3">User Remark</TableHead>
// //                               <TableHead className="w-[28%] text-center text-xs font-semibold py-3">Developer Remark</TableHead>
// //                               <TableHead className="w-[12%] text-center text-xs font-semibold py-3">Software Type</TableHead>
// //                               {canActOnComplaint && <TableHead className="w-[15%] text-center text-xs font-semibold py-3">Actions</TableHead>}
// //                             </TableRow>
// //                           </TableHeader>
// //                           <TableBody>
// //                             <TableRow>
...
// //                                 <div className="break-words whitespace-normal max-h-24 overflow-y-auto px-1">
// //                                   {getUserRemark() || <span className="text-muted-foreground/70 italic text-xs">—</span>}
// //                                 </div>
// //                               </TableCell>
// //                               <TableCell className="text-xs py-2 align-top">
// //                                 <div className="break-words whitespace-normal max-h-24 overflow-y-auto px-1">
// //                                   {getDeveloperRemark() || <span className="text-muted-foreground/70 italic text-xs">—</span>}
// //                                 </div>
// //                               </TableCell>
// //                               <TableCell className="text-center text-xs py-2">{complaint.softwareType}</TableCell>
// //                               {canActOnComplaint && (
...
// //                 {/* Re-open dialog (shown when showReopenBox is true) */}
// //                 {showReopenBox && (
...
// //                 {complaint.status === 'closed' && complaint.closedByUser && (
...
// //                 {/* Support Information */}
// //                 <Card className="bg-gradient-to-r from-green-50 to-accent/20">
// //                   <CardContent className="p-6">
